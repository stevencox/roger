...
class KGXModel:
    ...
    def merge (self):
        ...
        json_node_iterators = [Util.json_iter(file_name, 'nodes') for file_name in json_format_files] 
        json_edge_iterators = [Util.json_iter(file_name, 'edges') for file_name in json_format_files] 
